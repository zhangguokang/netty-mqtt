...
public class MqttClient {
    ...
    public static void test(String userName, String passWord) {
        ...
        try {
            ...
            MQTT mqtt = setOpt(userName, passWord);
            // 使用回调式API
            ...
            callbackConnection.connect(new Callback<Void>() {
                ...
                public void onSuccess(Void v) {
                    // 订阅主题
                    Topic[] topics = { new Topic("chat/876543210", QoS.EXACTLY_ONCE) };
    ...
    public static MQTT setOpt(String userName, String passWord) throws URISyntaxException {
